...
def main():
  ...
  print("Detected " + str(rank_count) + " ranks. :3")
  

  # Load checkpoint ranks.
  print("Loading ranks. :3")
  ranks = []
  ...
  # Save.
  print("Saving new ranks. :3")
  if args.output_folder is not None:
    output_folder = args.output_folder
    os.makedirs(args.output_folder, exist_ok=True)
  else:
    print("Overwriting old ranks. Because you didn't provide the --output-folder ^_^''")
